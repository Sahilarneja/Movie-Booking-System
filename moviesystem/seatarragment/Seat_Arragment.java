...
public class Seat_Arragment {
    ...
    public void SEAT_DISPLAY(int input01, int input02) {
        ...
        if (input01 == 1 && input02 == 1) {
            ...
            System.out.println("Please have a look at the seating plan FOR TAMASHA ");

        }
        else if (input01 == 1 && input02 == 3) {
            System.out.println("Please have a look at the seating plan FOR ROCKSTAR ");

        }
        else if (input01 == 2 && input02 == 1) {
            System.out.println("Please have a look at the seating plan FOR SAUKAN SAUKANE ");
        }
        else if (input01 == 2 && input02 == 2) {
            System.out.println("Please have a look at the seating plan FOR QISMAT2 ");

        }
        else if (input01 == 2 && input02 == 3) {
            System.out.println("Please have a look at the seating plan FOR CARRY ON JATTA ");
        }
